...
export class ChatThread {
  ...
  private async *listChatReadReceiptsPagingPage(
    ...
    while (continuationToken) {
      result = await this._listChatReadReceiptsNext(
        chatThreadId,
        continuationToken,
        options
      );
  ...
  private async *listChatReadReceiptsPagingAll(
    ...
    for await (const page of this.listChatReadReceiptsPagingPage(
      chatThreadId,
      options
    )) {
      yield* page;
  ...
  private async *listChatMessagesPagingPage(
    ...
    let continuationToken = result.nextLink;
    while (continuationToken) {
      result = await this._listChatMessagesNext(
        chatThreadId,
        continuationToken,
        options
      );
  ...
  private async *listChatMessagesPagingAll(
    ...
    for await (const page of this.listChatMessagesPagingPage(
      chatThreadId,
      options
    )) {
      yield* page;
  ...
  private async *listChatParticipantsPagingPage(
    ...
    let continuationToken = result.nextLink;
    while (continuationToken) {
      result = await this._listChatParticipantsNext(
        chatThreadId,
        continuationToken,
        options
      );
  ...
  private async *listChatParticipantsPagingAll(
    ...
    for await (const page of this.listChatParticipantsPagingPage(
      chatThreadId,
      options
    )) {
      yield* page;
